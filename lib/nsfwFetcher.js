...
const BLOCKED_TAGS = new Set([
  ...
  "group_sex", "groupsex", "gangbang", "gang_bang", "threesome", "foursome", "orgy", "multiple_partners", "multiple_male", "harem", "polyamory",
...
const VISUAL_REVIEW_PROMPT = [
  ...
  "REJECT: visibly low-quality or malformed AI art, western/cartoon style, any recognizable character from a current or old TV series, movie, comic, game, or other franchise, child-franchise art, furry/anthropomorphic animals, animal-on-animal or bestiality content, group sex, gangbang, threesome, orgy or multiple-partner content, non-consensual, forced, rape, coercive, captive, prison or torture content, futa/dickgirl/shemale anatomy, or content with a watermark, logo or promotional text.",
