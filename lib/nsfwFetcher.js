...
const DANBOORU_TAGS = {
  ...
  feet: "feet rating:e",
  yuri: "yuri rating:e",
  lesbian: "female_on_female rating:e",
  ...
  solo: "solo rating:e",
  gasm: "orgasm rating:e -futanari -futa -gynomorph -andromorph -hermaphrodite -crossdressing -intersex -newhalf -otoko_no_ko -male_to_female -transgender -yaoi -bl -boys_love -boyslove -gay -male_on_male -male_male -bara",
...
const BOORU_TAGS = {
  ...
  lesbian: ["female_on_female rating:explicit -furry -anthro -feral"],
  ...
  gasm: ["orgasm rating:explicit -futanari -futa -gynomorph -andromorph -hermaphrodite -crossdressing -intersex -newhalf -otoko_no_ko -male_to_female -transgender -yaoi -bl -boys_love -boyslove -gay -male_on_male -male_male -bara -furry -anthro -feral"],
...
const CATEGORY_REQUIRED_TAGS = {
  ...
  lesbian: ["female_on_female", "yuri"], ahegao: ["ahegao"], gasm: ["orgasm", "female_orgasm"],
...
const PUBLIC_CATEGORY_APIS = {
  ...
  gasm: { endpoints: [{ url: "https://nekos.life/api/v2/img/gasm", field: "url", isExactCategory: true }] },
...
const VISUAL_REVIEW_PROMPT = [
  ...
  "REJECT: visibly low-quality or malformed AI art, western/cartoon style, any recognizable character from a current or old TV series, movie, comic, game, or other franchise, child-franchise art, furry/anthropomorphic animals, animal-on-animal or bestiality content, futa/dickgirl/shemale anatomy, or content with a watermark.",
...
const STRICT_CATEGORY_VISUAL_REQUIREMENTS = {
  ...
  gasm: "It must clearly depict an adult female orgasm or climax. A heterosexual adult man with an adult woman is allowed; reject futa, incompatible male anatomy, male-only and male-with-male content. REJECT any distinct ahegao expression or ahegao-styled face.",
...
export async function getNsfwImageCandidate(category, options = {}) {
  ...
  const filterMediaType = (items) => options.allowAnimated === true
    ? items
