...
Como regla adicional, se excluyen `futanari`/`futa`, `intersex`, `newhalf`, `otoko_no_ko`, `transgender` y variantes de anatomía masculina incompatible en personajes femeninos, incluidos `dickgirl`, `dick_girl`, `shemale`, `penis_on_female`, `female_with_penis` y `female_penile`. También se excluyen `yaoi`, `bl`, `boys_love`, `gay`, `male_on_male`, `male_male`, `boy_on_boy` y `bara`. Se bloquean además `furry`, `anthro`, `feral`, `animal_on_animal`, `animal_sex`, `animal_mating` y etiquetas equivalentes de bestialidad. Asimismo, se excluyen los fetiches `hyper`, `breast_expansion`, `breast_expansion_animation`, `breast_expansion_fetish`, `breast_growth`, `dick_nipples`, `dicknipples`, `phallic_nipples` y `phallic_nipple`. **No se excluyen** `hetero`, `straight`, `male`, `1boy`, `male_on_female`, `breasts`, `large_breasts` ni `huge_breasts` por sí solas, ni la participación de un hombre con una mujer adulta.
